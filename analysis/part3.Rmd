...
load("C:/han/Projects/Multi_Omics/multi_omics/data/dat_pfc35_20241203.RData") # load data dat_pfc35
...
fisher.test(matrix(c(3100, 47, length(intersect(colnames(dat_pfc35), ASC_gene)), length(intersect(genes_pfc35, ASC_gene))), nrow=2))
```
...
fisher.test(matrix(c(3100, 47, length(intersect(colnames(dat_pfc35), DD_ID_gene)), length(intersect(genes_pfc35, DD_ID_gene))), nrow=2))
...
fisher.test(matrix(c(3100, 47, length(intersect(colnames(dat_pfc35), SCZ_GWAS_gene)), length(intersect(genes_pfc35, SCZ_GWAS_gene))), nrow=2))
```
...
topmirage_enrichment=
  ...
  theme(axis.text.y = element_text(size = 15))+ # this is for numbers on y axis 
   ...
   geom_signif(annotations ="0.005", y_position = 0.14  ,xmin=0.7, xmax=1, size=1, vjust=-0.5, textsize=textsize)+ # textsize is for text over the bar; size is for width of lines 
  ...
  geom_signif(annotations ="1e-04", y_position = 0.23  ,xmin=1.7, xmax=2, size=1, vjust=-0.5, textsize=textsize)+
   geom_signif(annotations ="0.002", y_position = 0.09  ,xmin=2.7, xmax=3.3, size=1, vjust=-0.5, textsize=textsize)+
  geom_signif(annotations ="0.034", y_position = 0.052  ,xmin=2.7, xmax=3.0, size=1, vjust=-0.5, textsize=textsize)+
